...
SEED_CATEGORIES = [
    ...
    (120, "Kiosco/Almacén", "store", "Kiosco"),
    (121, "Juguetería", "game", "Juguetes"),
    (122, "Polirrubro", "shop", "Varios"),
    (123, "Cuidado de personas", "heart", "Cuidado personal"),
    (124, "Alquiler", "home", "Alquiler"),
    (125, "Municipio", "building", "Municipio"),
    (126, "Apoyo escolar", "graduation-cap", "Apoyo educativo"),
    (127, "Escribanía", "pen-tool", "Notarial"),
    (128, "Flete", "truck", "Mudanzas"),
    (129, "Imprenta", "printer", "Impresiones"),
    (130, "Vinoteca", "wine", "Vinos"),
    (131, "Heladería", "ice-cream", "Helados"),
    (132, "Sanatorio", "hospital", "Salud"),
    (133, "Taller", "wrench", "Taller"),
    (134, "Mecánico", "car", "Mecánica"),
    (999, "Otro", "more", "Otros"),
]
