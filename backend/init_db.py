...
CATEGORIES = [
    ...
    (120, "Kiosco/Almacén", "store", "Kiosco y almacén"),
    ...
    (125, "Municipio", "building", "Oficinas municipales"),
    (126, "Apoyo escolar", "graduation-cap", "Tutorías y apoyo educativo"),
    (127, "Escribanía", "pen-tool", "Servicios notariales"),
    (128, "Flete", "truck", "Servicios de flete y mudanzas"),
    (129, "Imprenta", "printer", "Impresiones y gráfica"),
    (130, "Vinoteca", "wine", "Vinos y bebidas"),
    (131, "Heladería", "ice-cream", "Helados"),
    (132, "Sanatorio", "hospital", "Centro de salud"),
    (133, "Taller", "wrench", "Taller general"),
    (134, "Mecánico", "car", "Mecánica automotriz"),
