...
- [Fecha] Elección de FastAPI sobre Django/Falcon por rendimiento y async natívо
...
- [Fecha] Configuración de CORS necesaria para PWA funcionando en dominio diferente
...
- [Fecha] Configuración de uvicorn para producción (workers, timeout, etc.)
